...
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey)](https://github.com/FunnyEntity/steam_library_exporter)
...
```bash
git clone https://github.com/FunnyEntity/steam_library_exporter.git
...
| Step | Action |
|---|---|
| Fork | Click the **Fork** button on the [GitHub repo](https://github.com/FunnyEntity/steam_library_exporter) |
